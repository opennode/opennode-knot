# -*- coding: utf-8 -*-
#
# KNOT documentation build configuration file, created by
...
latex_documents = [
  ('index', 'KNOT.tex', u'KNOT Documentation',
...
man_pages = [
    ('index', 'oms', u'KNOT Documentation',
     [u'Opennode Ltd'], 1)
]
...
texinfo_documents = [
  ('index', 'KNOT', u'KNOT Documentation',
   u'Opennode Ltd', 'KNOT', 'One line description of project.',
   'Miscellaneous'),
]
